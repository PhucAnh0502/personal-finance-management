...
class _AddTransactionScreenState extends State<AddTransactionScreen>
  ...
  void _submitTransaction() async {
    ...
    if (_selectedCategoryId == null && _transactionType == TransactionType.expense) {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text('${_transactionType == TransactionType.income ? "Income" : "Expense"} added successfully'),
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    Expanded(
                      child: _buildTypeButton(TransactionType.expense, 'Expense', Icons.arrow_downward, AppColors.expense),
                    ),
                    const SizedBox(width: 12),
                    Expanded(
                      child: _buildTypeButton(TransactionType.income, 'Income', Icons.arrow_upward, AppColors.primaryEmerald),
                    ),
                  ],
                ),
                ...
                TextFormField(
                  ...
                  decoration: InputDecoration(
                    ...
                    prefixIcon: const Icon(Icons.attach_money, color: AppColors.primaryEmerald),
                    suffixText: 'VND',
                ...
                if (_transactionType == TransactionType.expense) ...[
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Row(
                        children: [
                          const Icon(Icons.category, color: AppColors.primaryEmerald),
                          const SizedBox(width: 12),
                          Expanded(
                            child: Text(
